...
- [x] **P2 / 16** — [Gezi ve harcama düzenleme arayüzleri eksik](issues/16-todo.md)
- [x] **P2 / 17** — [Mobil takvim ve hata kurtarma kabul kriterleri eksik](issues/17-todo.md)
- [x] **P2 / 18** — [Test kapsamı kritik iş akışlarını doğrulamıyor](issues/18-todo.md)
